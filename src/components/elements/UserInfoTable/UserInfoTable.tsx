...
type Props = {
    ...
    removeItem: (currentId: string) => void;
};

export const UserInfoTable: React.FC<Props> = ({ userInfo, changeInfo, removeItem }) => {
    return (
        <table className='relative table-fixed w-full text-left border border-collapse break-all border-grey mb-6 last:mb-0'>
            <thead>
                <tr>
